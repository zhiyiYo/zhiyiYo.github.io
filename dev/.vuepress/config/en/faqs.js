export const faqs = {
    ...
    description: 'Have a different question and can’t find the answer you’re looking for? Reach out to our support team by <a href="mailto:shokokawaii@foxmail.com" class="faq-email">sending us an email</a> and we’ll get back to you as soon as we can.',
    items: [
        {
            question: 'Do I need to purchase a license for python commercial software?',
            answer: 'Yes, the component library is protected by copyright, with registration number 12532763. Unauthorized commercial use is considered infringement.',
        },
        {
        ...
        },
        {
            ...
            answer: 'It supports Qt 5.12~5.15 and Qt6. QFluentWidgets is developed based on QWidgets and does not support QML. Contact us if you need support for lower versions of Qt.',
        }
    ]
};